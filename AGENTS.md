...
- There is currently no active reliable SaaS Reddit ingestion path. The main app still owns source records, OpenAI angle extraction after valid sources, queueing, publishing, logs, billing, source ownership checks, and the internal owner access override.
