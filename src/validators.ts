...
export function parseRuntimeSettingsPatch(settings: UnknownRecord): UnknownRecord {
  ...
  if ('OPENAI_IMAGE_TIMEOUT_MS' in settings) next.OPENAI_IMAGE_TIMEOUT_MS = asInteger(settings.OPENAI_IMAGE_TIMEOUT_MS, 'settings.OPENAI_IMAGE_TIMEOUT_MS', { min: 1000, max: 300000 });
